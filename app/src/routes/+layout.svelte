		...
		{:else}
			...
			<nav class="fixed bottom-0 left-0 right-0 bg-background border-t border-border md:hidden">
				<div class="flex items-center justify-around h-16">
					<a href="/" class="flex flex-col items-center gap-1 px-2 py-1 text-xs
					...
					<a href="/shifts" class="flex flex-col items-center gap-1 px-2 py-1 text-xs
					...
					<a href="/report" class="flex flex-col items-center gap-1 px-2 py-1 text-xs
					...
					<a href="/broadcasts" class="flex flex-col items-center gap-1 px-2 py-1 text-xs
						{page.url.pathname.startsWith('/broadcasts') && !page.url.pathname.startsWith('/admin') ? 'text-primary' : 'text-muted-foreground'}">
						<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
					...
					<a href="/bookings" class="flex flex-col items-center gap-1 px-2 py-1 text-xs
