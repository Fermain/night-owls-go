...
<svelte:head>
	...
	<meta name="description" content="Join the Community Watch and help keep our neighborhood safe. View patrol schedules and sign up for shifts." />
</svelte:head>
		...
		<div class="container mx-auto text-center">
			<div class="mx-auto max-w-3xl">
				...
				<p class="mb-8 text-xl text-muted-foreground">
					Join the Community Watch and be part of a network dedicated to keeping our 
					neighborhood safe. Sign up for patrol shifts, connect with neighbors, and make a difference.
				</p>
	...
	<section class="py-16 px-4 bg-muted/50">
		<div class="container mx-auto">
			<div class="text-center mb-12">
				...
				<p class="text-muted-foreground text-lg">Simple steps to get involved in community safety</p>
			</div>
	...
	<section class="py-16 px-4">
		<div class="container mx-auto">
			<div class="text-center mb-12">
				...
				<p class="text-muted-foreground text-lg">See what patrol schedules are active in our community</p>
			</div>

			{#if $query.isLoading}
				<div class="text-center">
					<div class="mx-auto mb-4 h-8 w-8 animate-spin rounded-full border-2 border-current border-t-transparent"></div>
			...
			{:else}
				<div class="text-center">
					...
					<p class="text-sm text-muted-foreground">Join our community to be notified when new schedules are available.</p>
				</div>
			{/if}
		</div>
	</section>
