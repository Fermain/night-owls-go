...
func TestScheduleService_GetUpcomingAvailableSlots_NoSchedules(t *testing.T) {
	...
	mockQuerier.On("ListActiveSchedules", mock.Anything, mock.AnythingOfType("db.ListActiveSchedulesParams")).Return([]db.Schedule{}, nil).Once()
...
func TestScheduleService_GetUpcomingAvailableSlots_SingleScheduleNoBookings(t *testing.T) {
	...
	mockQuerier.On("ListActiveSchedules", mock.Anything, mock.AnythingOfType("db.ListActiveSchedulesParams")).Return([]db.Schedule{schedule1}, nil).Once()
