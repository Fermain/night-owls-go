...
// GenerateJWT generates a new JWT for a given user ID and phone number.
func GenerateJWT(userID int64, phone string, jwtSecret string, expirationHours int) (string, error) {
